...
<div class="offcanvas offcanvas-end offcanvas-menu bg-secondary" id="offcanvasMenu">
  ...
  <div class="offcanvas-body">
    <ul class="mobile-primary-menu">
      <li>
        <a href="<?php echo e(route('client.home')); ?>" class="menu-item-link active"><span>Home</span></a>
      </li>
        ...
        <ul class="sub-menu sub-menu-mega">
          <li class="mega-menu-item">
            <ul>
              ...
              <?php $__currentLoopData = $categories->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li>
                  <a class="sub-item-link" href="<?php echo e(route('shop.filterByCategory', ['category_id' => $category->category_id])); ?>">
  ...
  <ul class="sub-menu">
    ...
    <li><a class="sub-item-link" href="<?php echo e(route('coming-soon')); ?>"><span>Coming Soon</span></a></li>
      ...
      <li><a class="menu-item-link" href="<?php echo e(route('about')); ?>"><span>About</span></a></li>
      <li><a class="menu-item-link" href="<?php echo e(route('contact')); ?>"><span>Contact</span></a></li>

      <?php if(auth()->guard()->check()): ?>
      <li>
        <a class="menu-item-link" href="<?php echo e(route('client.profile', ['userid' => Auth::user()->user_id])); ?>"><span>Profile</span></a>
      </li>
      <li>
        <form id="logout-form-offcanvas" action="<?php echo e(route('logout')); ?>" method="POST" style="display: none;"><?php echo csrf_field(); ?></form>
      ...
      <?php if(auth()->guard()->guest()): ?>
      <li>
        <a class="menu-item-link" href="<?php echo e(route('login')); ?>"><span>Login</span></a>
      </li>
      <?php endif; ?>
    </ul>
