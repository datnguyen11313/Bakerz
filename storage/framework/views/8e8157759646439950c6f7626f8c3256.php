...
<?php echo $__env->make('layouts.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
  ...
  <img src="<?php echo e(asset('img/pie-spinner.png')); ?>" alt="Loading..." class="rotate-spinner" style="width: 50px; height: 50px; margin-left: 10px;">
</div>
    ...
    // Gửi Ajax để lọc sản phẩm theo sức khỏe
    $.ajax({
        url: $('#filterForm').attr('action'),
        type: 'GET',
        data: $('#filterForm').serialize(),
        success: function (response) {
            ...
            // Hiện khu vực #a2 trước khi scroll
            ...
            if (a1) {
                a1.scrollIntoView({ behavior: 'smooth' });

                // Sau khi scroll xong 500ms, tắt loading
                setTimeout(() => {
                    document.getElementById('loadingOverlay').style.display = 'none';
                    sessionStorage.removeItem('scrollToA1');
                }, 600);
            } else {
                // Nếu không có a1 thì vẫn tắt loading
                document.getElementById('loadingOverlay').style.display = 'none';
            }
        },
        error: function (xhr, status, error) {
...
<?php /**PATH /var/www/html/resources/views/client/home.blade.php ENDPATH**/ ?>